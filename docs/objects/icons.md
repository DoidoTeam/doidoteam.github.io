...
![](https://doidoteam.github.io/img/wiki-old/icons.png){width=900}

Icon are located in `assets/images/icons/` with the name `icon-YOUR_CHARACTER_NAME`.

### Configuring Health Bar color

![](https://doidoteam.github.io/img/wiki-old/getcolor.png){width=400}
...
![](https://doidoteam.github.io/img/wiki-old/iconstates.png){width=600}
